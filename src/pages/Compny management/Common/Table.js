...
import { Filter, DefaultColumnFilter } from "../../Compny management/Common/filters"
import left from "../../Compny management/Common/imges/left.svg";
import right from "../../Compny management/Common/imges/right.svg";
  ...
  return (
    <Fragment>
      ...
      <Row className="table_footer">
        <Col md="6">
          <p className="total-page text-black-v2 font-small font-semibold">1-8 of 25</p>
        </Col>
        <Col md="6">
          <div className="table-footer-right-content d-flex align-items-center justify-content-end">
            ...
            <div className="page_index"> <p className="page-index text-blue font-semibold"> {pageIndex + 1} / {pageOptions.length}</p></div>
            <div className="d-flex gap-1">
