            ...
            <Col lg={6}>
              <div className='right_content'>
                <div className="text-center mt-2">
                  <img className='s-icon mb-0 mb-3' src={checkemail} alt="" />
                  <h5 className="m-0">Check your Email</h5>
                  <div className='forgot-content'>
                    <p className='text-muted m-0 font-normal'>We’ve sent a password reset link to red*******@gmail.com</p>
                  </div>
                </div>
                <div className="p-2 mt-4">
                  ...
                  <button className='g-btn mt-0'>
                    ...
                    <div className="mt-4 text-center form-footer ">
                      <p className="mb-0 text-muted font-normal">Didn’t receive an email?  <a href="/login" className="fw-medium text-primary font-normal">Resend link</a> </p>
                    </div>
                </div>
              </div>
            </Col>
