                    ...
                    <table className="table table-bordered table-striped table-nowrap mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><code>{`<Col xs={}> ... </Col>`}</code></td>
                          <td><code>{`<Col sm={}> ... </Col>`}</code></td>
                          <td><code>{`<Col md={}> ... </Col>`}</code></td>
                          <td><code>{`<Col lg={}> ... </Col>`}</code></td>
                          <td><code>{`<Col xl={}> ... </Col>`}</code></td>
                          <td><code>{`<Col xxl={}> ... </Col>`}</code></td>
                        </tr>
                        <tr>
