        ...
        <Container fluid={true}>
          ...
          <Row>
            <Col xl={4}>
              <Card>
                <CardBody>
                  <h5 className="mb-3 font-size-18 text-center">Hex : #6062F9</h5>
                  <Row>
            ...
            <Col xl={4}>
              <Card>
                <CardBody className="text-center">
                  <h5 className="mb-3 text-center">Hex : #EFFFF0</h5>
                  <Row>
            ...
            <Col xl={4}>
              <Card>
                <CardBody className="text-center">
                  <h5 className="mb-3 text-center">Hex : #FFEDED</h5>
                  <Row>
            ...
            <Col xl={4}>
              <Card>
                <CardBody className="text-center">
                  <h5 className="mb-3 text-center">Hex : #9F9EB2</h5>
                  <Row>
