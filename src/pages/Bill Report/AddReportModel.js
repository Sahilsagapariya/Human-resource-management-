...
const FileLoginModel = ({ show, onCloseClick, data, id }) => {
  ...
  return (
    <Modal isOpen={show} toggle={onCloseClick} centered={true}>
      <ModalHeader>
        {id ? "Update Report" + " " + id : "Add New Report"}
      </ModalHeader>
      <ModalBody>
        <Form
          ...
          <Row className="g-4">
            ...
            <Col lg={6}>
              <FormGroup floating>
                ...
                {validation.touched.companyRefNo && validation.errors.companyRefNo ? (
                  <FormFeedback type="invalid">
                    {validation.errors.companyRefNo}
                  </FormFeedback>
                ) : null}
