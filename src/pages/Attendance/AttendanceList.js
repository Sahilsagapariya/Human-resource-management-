...
import { Col, Row, Label, Input, Form, FormGroup, Badge } from "reactstrap"
...
function Attendance() {
  ...
  const [usersAttendanceList, setusersAttendanceList] = useState(users)
      ...
      },
      {
        ...
        Cell: cellProps => {
          return (
            <div>
              <a
                href={`/attendance-list/${cellProps.row.original.employee_Id}`}
          ...
          <div className="server_info">
            ...
            <div className="row mt-3">
              <div
                ...
                onClick={() => {
                  id
                    ? setusersAttendanceList([...users].filter(ele => ele))
            ...
            <Col xs="12">
              <div className="table_v1">
                <TableContainer
                  ...
                  data={id ? usersAttendanceList : attendanceList}
